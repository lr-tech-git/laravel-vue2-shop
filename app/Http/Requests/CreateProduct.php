...
class CreateProduct extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'id_number' => 'nullable|unique:products,id_number',
            'categories' => ['required', 'array'],
            'categories.0.value' => ['required', 'integer'],
            ...
            'installment.recurring_period' => 'required_with:installment|string',
            'installment.billing_cycles' => 'required_with:installment|integer|min:1',
            'installment.fee' => 'required_with:installment|numeric|min:0',
            'installment.fee_type' => 'required_with:installment|integer',
        ];
    }
